...
```
<link rel="stylesheet" href="http://unpkg.com/tachyons-box-shadow@2.0.4/css/tachyons-box-shadow.min.css" />
```
 ...
 */
.shadow-1 { box-shadow: 0 0 4px 0 rgba( 0, 0, 0, .2 ); }
.shadow-2 { box-shadow: 0 0 8px 2px rgba( 0, 0, 0, .2 ); }
.shadow-3 { box-shadow: 2px 2px 4px 2px rgba( 0, 0, 0, .2 ); }
.shadow-4 { box-shadow: 2px 2px 8px 0 rgba( 0, 0, 0, .2 ); }
.shadow-5 { box-shadow: 4px 4px 8px 0 rgba( 0, 0, 0, .2 ); }
@media screen and (min-width: 30em) {
 .shadow-1-ns { box-shadow: 0 0 4px 0 rgba( 0, 0, 0, .2 ); }
...
@media screen and (min-width: 30em) and (max-width: 60em) {
 .shadow-1-m { box-shadow: 0 0 4px 0 rgba( 0, 0, 0, .2 ); }
...
@media screen and (min-width: 60em) {
 .shadow-1-l { box-shadow: 0 0 4px 0 rgba( 0, 0, 0, .2 ); }
